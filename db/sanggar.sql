...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 14 Des 2020 pada 15.24
...
--
-- Struktur dari tabel `gambar_product`
--
...
--
-- Dumping data untuk tabel `gambar_product`
--
...
('INV111220000001', '2020-12-11', '2020-12-13', 8, '2020-12-11', 'BELUM LUNAS', 40, 0, 0, 5, NULL, 'ambil_sendiri', 0, NULL, 's', 0, '2020-12-14'),
('INV111220000002', '2020-12-13', '2020-12-15', 60, '2020-12-11', 'BELUM LUNAS', 40, 0, 0, 1, NULL, 'ambil_sendiri', 0, NULL, 's', 0, '2020-12-16');
...
--
-- Indeks untuk tabel `gambar_product`
--
...
--
-- AUTO_INCREMENT untuk tabel `gambar_product`
--
ALTER TABLE `gambar_product`
